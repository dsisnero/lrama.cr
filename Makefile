.PHONY: build install spec spec-all spec-provider spec-provider-record spec-interactive clean format docs build-examples update_lrama update_racc update_submodules
